				...
				while (true) {
					...
					if (o instanceof ObjectWrapper) {
						...
						case ObjectWrapper.LOGIN_USER:
							...
							break;
						case ObjectWrapper.SCOREBOARD:
							PlayerDAO ud1 = new PlayerDAO();
							ArrayList<Player> players = ud1.getAllPlayers();
							oos.writeObject(new ObjectWrapper(ObjectWrapper.REPLY_SCOREBOARD, players));
							break;
						}
